...
app= FastAPI(title='NBA Games Analytics', version='1.0',
...
class Data(BaseModel):
    ...
    # W_PCT_prev_home:float HOME_RECORD_prev_home:float
    # ROAD_RECORD_prev_home:float G_away:float W_PCT_away:float HOME_RECORD_away:float
    # ROAD_RECORD_away:float W_PCT_prev_away:float HOME_RECORD_prev_away:float
    # ROAD_RECORD_prev_away:float WIN_PRCT_home_3g:float PTS_home_3g:float
    # FG_PCT_home_3g:float FT_PCT_home_3g:float FG3_PCT_home_3g:float AST_home_3g:float
    # REB_home_3g:float WIN_PRCT_away_3g:float PTS_away_3g:float FG_PCT_away_3g:float
    # FT_PCT_away_3g:float FG3_PCT_away_3g:float AST_away_3g:float REB_away_3g:float
    # WIN_PRCT_home_10g:float PTS_home_10g:float FG_PCT_home_10g:float
    # FT_PCT_home_10g:float FG3_PCT_home_10g:float AST_home_10g:float REB_home_10g:float
    # WIN_PRCT_away_10g:float PTS_away_10g:float FG_PCT_away_10g:float
    # FT_PCT_away_10g:float FG3_PCT_away_10g:float AST_away_10g:float REB_away_10g
